...
---
### 27/04/2026
- **¿Qué hice?** Empezamos a revisar qué nos faltaba para completar el nivel de matrícula. Leímos los requisitos y decidimos que el siguiente paso sería documentar los principios SOLID en el README para dejar constancia de cómo los hemos aplicado en el proyecto.
- **¿Algún problema?** Al principio no teníamos muy claro cómo explicar cada principio de forma sencilla sin copiar directamente la definición teórica.
---
### 28/04/2026
- **¿Qué hice?** Estuvimos repasando el código para ver dónde habíamos aplicado cada principio SOLID. Fuimos fichero por fichero anotando ejemplos concretos para luego poder escribirlos bien en el README.
- **¿Algún problema?** Costó un poco entender la diferencia entre ISP y SRP porque se parecen bastante.
---
### 29/04/2026
